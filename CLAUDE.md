...
## Post Writing Style (MANDATORY)

Posts must read as written by a human, not generated by AI. Follow these rules when composing any post:

**Avoid these AI tells:**
- Em dashes `—`: use a comma, colon, or rewrite the sentence instead
- Filler phrases: "dive into", "delve", "it's worth noting", "in today's world", "landscape", "crucial", "game-changer", "unleash", "harness"
- Overly parallel bullet structures that all start with the same word pattern
- Hollow openers: "I'm excited to share", "Thrilled to announce", "As a [role]"
- Excessive hedging: "This is just one approach", "of course your mileage may vary"

**Do:**
- Write short, direct sentences
- Use the user's natural voice and vocabulary — ask if unsure
- Vary sentence length
- Use a hyphen `-` or colon `:` where a dash feels needed
- Sound like a practitioner writing a quick note, not a press release
